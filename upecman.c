/***************************************************************************
 * upecman.c                              Version 2.5 (Cherry Fix)         *
 * Pacman Ncurses - Optimized for Presentation                           *
 ***************************************************************************/
...
/* ==========================================================================
   ...
   ========================================================================== */
    ...
    while(kin != 'e') 
    {
        ...
        if((TempoAfraid == 0) || (TempoAfraid == 1 && (clock() - afraid_t) > 10000)) { 
            TempoAfraid = 0;
...
void pacHelp() {
    ...
    WINDOW *h = newwin(r-4, c-8, 2, 4); box(h,0,0);
    mvwprintw(h,2,2,"INSTRUCOES:"); mvwprintw(h,4,2,"- Setas: Mover");
    wrefresh(h); getch(); delwin(h);
}
